...
class tutorial.chapter_04 extends basic_chapter
{
	...
	//Step 1 =====================================================================================
	//Productor
	fac_1 = {c = coord(127,82), c_list = null /*auto started*/, name = "" /*auto started*/, good = good_alias.oel}

	//Fabrica
	fac_2 = {c = coord(110,71), c_list = null /*auto started*/, name = "" /*auto started*/, good = good_alias.oel}

	//Step 2 =====================================================================================
	//Para los muelles
	dock_list1 = [coord(115,77)]
	...
	sch_list1 = [coord(127,82), coord(115,77)]
	...
	//Consumidor Final
	fac_3 = {c = coord(94,76), c_list = null /*auto started*/, name = "" /*auto started*/, good = good_alias.gas}
	d2_cnr = null //auto started

	sch_list2 = [coord(115,77), coord(97,77)]

	//Step 6 =====================================================================================
	c_dep2 = coord(94,46)
	sch_list3 = [coord(96,47), coord(87,33), coord(71,25)]
	dock_list2 = [coord(96,47), coord(87,33), coord(71,25)]
		...
		switch (this.step) {
			...
			case 5:
				...
				//Para Astillero
					...
					local t1 = tile_x(c_dep1.x, c_dep1.y, 0)
					local depot = t1.find_object(mo_depot_water)
	...
	function set_all_rules(pl) 
	{
		...
		local forbid =	[	
							4136, 4140, 4126, 4103, 4134, 4135, tool_lower_land, tool_raise_land, tool_restoreslope, tool_add_city,
		...
		switch (this.step) {
			...
			case 2:
				local forbid =	[	
									tool_build_way, tool_build_bridge, tool_build_depot, tool_remove_way, tool_build_tunnel,
			...
			case 3:
				local forbid =	[
									tool_build_way, tool_build_bridge, tool_remove_way, tool_build_tunnel, tool_build_roadsign,
	...
	function is_tool_allowed(pl, tool_id, wt){
		...
		local gt_list =	[
							t_icon.rail, t_icon.road, t_icon.plane, t_icon.slope, t_icon.tram,
							t_icon.narr, t_icon.magl, t_icon.exte, t_icon.wremo, t_icon.other
						]
		if(step < 2){
			gt_list.push(t_icon.ship)
