...
class tutorial.chapter_03 extends basic_chapter
{
	...
	//Step 1 =====================================================================================
	//Productor
	fac_1 = {c = coord(74,103), c_list = null /*auto started*/, name = "" /*auto started*/, good = good_alias.grain}
	//fac_1.name = "grain_farm_w_fields"
	//fac_1.c = coord(64,40)
	f1_lim = {a = coord(60,36), b = coord(69,45)}
	f1_list = null //auto started
	//fac_1.good = good_alias.grain
	
	//Fabrica
	fac_2 = {c = coord(115,110), c_list = null /*auto started*/, name = "" /*auto started*/, good = good_alias.grain}
	//fac_2.name = "grain_mill"
	//fac_2.c = coord(36,4)
	//f2_lim = {a = coord(36,4), b = coord(36,6)}
	//fac_2.good = good_alias.flour
		...
		switch (this.step) {
			...
			case 7:
				...
				if(pot0==0){
					...
					reached = get_reached_target(f3_coord, fac_2.good)
